...
const WatchVideosInGroup = (): JSX.Element => {
    ...
    <Stack direction={direction} justifyContent="center" data-aos="fade">
      <Center w={size} data-aos="zoom-in">
        <video autoPlay loop muted width="80%">
          <source src="/video/watchvideosingroup.mp4" type="video/mp4" />
        </video>
      </Center>
        ...
        <VStack spacing="5" w="100%">
          <VStack textAlign="center">
            <Text fontSize={fontTitle} fontWeight="500">
              watchvideoin.group &nbsp;
              <Link href="https://watchvideosin.group" isExternal>
                <ExternalLinkIcon h="4" w="4" mb="1" />
              </Link>
            </Text>

            <Text fontSize={fontDescription}>
              Developed to study new techs like NestJS + Socket.io
            </Text>
          </VStack>
          <Wrap
            p="1.5"
...
export default WatchVideosInGroup;
